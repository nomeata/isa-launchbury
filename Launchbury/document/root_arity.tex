...
We formlize the Call Arity\cite{tfp} analysis, as implemented in GHC, and prove both functional correctness (with regard to a standard denotational semantics) and, more interestingly, safety (i.e.\ the transformation does not increase allocation).
