...
\begin{abstract}
We formlize the Call Arity analysis \cite{tfp}, as implemented in GHC, and prove both functional correctness and, more interestingly, safety (i.e.\ the transformation does not increase allocation). A highlevel overview of the work can be found in \cite{icfp15}, see Section~\ref{sec:table} for a mapping between that paper and this work.
...
Definition 2                                                  & \isacommand{locale} \isa{CorrectArityAnalysisLet}         & \seetheory{ArityAnalysisSpec} \\
Definition 3                                                  & \isacommand{locale} \isa{CorrectArityAnalysisLetNoCard}   & \seetheory{ArityAnalysisSpec} \\
...
Definition 6                                                  & \isacommand{locale} \isa{CardinalityPrognosisCorrect}     & \seetheory{CardinalityAnalysisSpec} \\
...
Lemma 4                                                       & \isacommand{sublocale} \isa{CardinalityPrognosisCorrect}  & \seetheory{TTreeImplCardinalitySafe} \\
...
Definition 10                                                 & \isacommand{locale} \isa{CoCallArityCorrect}              & \seetheory{CoCallAnalysisSpec} \\
