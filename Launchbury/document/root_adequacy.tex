...
TODO (complete):
Comparison with \cite{breitner2013}\dots
(results, finite maps)
...
\item A theory for working with functions into a pcpo as environments (\isa{Env}, \isa{Env-Nominal}, \isa{Env-HOLCF}).
\item A function \isa{heapToEnv} that converts between associative lists and functions. (\isa{HeapToEnv})
\end{itemize}
