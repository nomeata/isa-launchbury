...
\psi_n^A &\colon A \to A_n &\text{ corresponds to }&&@{term C_to_CValue_take}@{text "::"}&@{typeof "C_to_CValue_take :: nat \<Rightarrow> (C \<rightarrow> CValue) \<rightarrow> (C \<rightarrow> CValue)"} \\
