...
Chapter \ref{ch_denupd} defines the denotational semantics where $\sqcup$ means right-sided update, and proves Launchbury's semantics correct using the proof from his paper. Again, the heap semantics in \isa{HSemUpd} is abstract in the concrete type and denotation of expressions.
